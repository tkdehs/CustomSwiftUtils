...
open class Toast: Operation {
  ...
  public var text: String? {
    ...
    public var iconImageName: String? {
      get { return self.view.iconImageName }
      set { self.view.iconImageName = newValue }
    }
  ...
  public init(text: String?, iconImageName: String? = nil, delay: TimeInterval = 0, duration: TimeInterval = Delay.short) {
    self.delay = delay
